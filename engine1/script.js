...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"parallax",prev:"",next:"",duration:33*100,delay:30*100,width:830,height:360,autoPlay:true,autoPlayVideo:false,playPause:false,stopOnHover:true,loop:false,bullets:1,caption:true,captionEffect:"parallax",controls:false,responsive:1,fullScreen:false,onBeforeStep:0,images:0});